...
contract DxCFXBridge is Ownable, Initializable {
    ...
    function handleRedeem() public onlyOperator {
        ...
        if (redeemLen > maxRedeemLenPerCall) redeemLen = maxRedeemLenPerCall;
    ...
    function eSpaceAddStake(uint256 amount) public onlyOperator {
